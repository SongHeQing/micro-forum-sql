...
) ENGINE=InnoDB AUTO_INCREMENT=37 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章表'
...
) ENGINE=InnoDB AUTO_INCREMENT=172 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='文章点赞记录表'

CREATE TABLE `channel` (
  `id` int unsigned NOT NULL AUTO_INCREMENT COMMENT 'ID,主键',
  `channelname` varchar(96) NOT NULL COMMENT '频道名',
  `image` varchar(255) DEFAULT NULL COMMENT '频道封面',
  `background` varchar(255) DEFAULT NULL COMMENT '频道背景',
...
) ENGINE=InnoDB AUTO_INCREMENT=151 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='评论表'
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='评论点赞记录表'
...
CREATE TABLE `user` (
  ...
  `article_send_count` int unsigned NOT NULL DEFAULT '0' COMMENT '文章发送量',
  `comment_send_count` int unsigned NOT NULL DEFAULT '0' COMMENT '评论发送量',
  `channel_follow_count` int unsigned NOT NULL DEFAULT '0' COMMENT '频道关注量',
  `follow_count` int unsigned NOT NULL DEFAULT '0' COMMENT '用户关注量',
  `fans_count` int unsigned NOT NULL DEFAULT '0' COMMENT '粉丝数量',
  `like_count` int unsigned NOT NULL DEFAULT '0' COMMENT '获赞量',
